...
module pcam_v_demosaic_0_0_v_demosaic (
        s_axi_CTRL_AWVALID,
        s_axi_CTRL_AWREADY,
        s_axi_CTRL_AWADDR,
        s_axi_CTRL_WVALID,
...
pcam_v_demosaic_0_0_CTRL_s_axi #(
...
pcam_v_demosaic_0_0_entry_proc entry_proc_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
pcam_v_demosaic_0_0_AXIvideo2MultiBayer AXIvideo2MultiBayer_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
pcam_v_demosaic_0_0_Debayer Debayer_U0(
...
pcam_v_demosaic_0_0_ZipperRemoval ZipperRemoval_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
pcam_v_demosaic_0_0_MultiPixStream2AXIvideo MultiPixStream2AXIvideo_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
pcam_v_demosaic_0_0_fifo_w16_d3_S bayer_phase_c_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
pcam_v_demosaic_0_0_fifo_w8_d2_S imgBayer_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
pcam_v_demosaic_0_0_fifo_w24_d2_S_x imgRgb_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
pcam_v_demosaic_0_0_fifo_w24_d2_S_x imgUnzip_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
pcam_v_demosaic_0_0_start_for_Debayer_U0 start_for_Debayer_U0_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
pcam_v_demosaic_0_0_start_for_ZipperRemoval_U0 start_for_ZipperRemoval_U0_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
pcam_v_demosaic_0_0_start_for_MultiPixStream2AXIvideo_U0 start_for_MultiPixStream2AXIvideo_U0_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
`include "pcam_v_demosaic_0_0_hls_deadlock_detector.vh"
// synthesis translate_on

reg find_kernel_block = 0;
// synthesis translate_off
`include "pcam_v_demosaic_0_0_hls_deadlock_kernel_monitor_top.vh"
// synthesis translate_on

endmodule //pcam_v_demosaic_0_0_v_demosaic
