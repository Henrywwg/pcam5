...
module pcam_v_demosaic_0_0_hls_deadlock_idx0_monitor ( // for module pcam_v_demosaic_0_0_v_demosaic_inst
    input wire clock,
    input wire reset,
...
// instant sub module
 pcam_v_demosaic_0_0_hls_deadlock_idx1_monitor pcam_v_demosaic_0_0_hls_deadlock_idx1_monitor_U (
    .clock(clock),
    .reset(reset),
