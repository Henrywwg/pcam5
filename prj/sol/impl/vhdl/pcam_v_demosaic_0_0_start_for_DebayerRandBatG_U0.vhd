...
entity pcam_v_demosaic_0_0_start_for_DebayerRandBatG_U0 is 
    generic (
...
architecture rtl of pcam_v_demosaic_0_0_start_for_DebayerRandBatG_U0 is
...
------------------------Component----------------------
    component pcam_v_demosaic_0_0_start_for_DebayerRandBatG_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
...
begin
----------------------- Instantiation -----------------------
    U_pcam_v_demosaic_0_0_start_for_DebayerRandBatG_U0_ShiftReg : pcam_v_demosaic_0_0_start_for_DebayerRandBatG_U0_ShiftReg
    generic map (
...
entity pcam_v_demosaic_0_0_start_for_DebayerRandBatG_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end pcam_v_demosaic_0_0_start_for_DebayerRandBatG_U0_ShiftReg;

architecture rtl of pcam_v_demosaic_0_0_start_for_DebayerRandBatG_U0_ShiftReg is
