...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_imgRB \
    op interface \
    ports { imgRB_dout { I 24 vector } imgRB_empty_n { I 1 bit } imgRB_read { O 1 bit } imgRB_num_data_valid { I 3 vector } imgRB_fifo_cap { I 3 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_imgRgb \
    op interface \
    ports { imgRgb_din { O 24 vector } imgRgb_full_n { I 1 bit } imgRgb_write { O 1 bit } imgRgb_num_data_valid { I 32 vector } imgRgb_fifo_cap { I 32 vector } } \
} "
}
